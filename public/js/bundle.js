...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // // longitude, langitude
  ...
  locations.forEach(function (loc) {
    // Create marker
    var el = document.createElement('div'); // this marker is custom by jonas at css files
...
var stripe = Stripe('pk_test_51KfGl2Ap2JEIzkDBuhZQ8E78ttvRXSqZuZeXGowGbdcGf9MpxDvVoeqDamrxPCaSJkdrvc5jRcJLA3RNlsZpxupf00DW0Zy2qb');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              btnSaveSettings.textContent = 'Updating...'; // form programatically
            ...
            case 9:
              btnSaveSettings.textContent = 'Save password'; // reload the page
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              console.log('userPasswordForm called!!');
              e.preventDefault();
